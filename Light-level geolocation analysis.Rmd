...
<!--chapter:end:05-GeoLight.Rmd-->

# probGLS {#probGLS}

<!--chapter:end:06-probGLS.Rmd-->

# SGAT {#SGAT}

<!--chapter:end:07-SGAT.Rmd-->

# FLightR {#FLightR}

<!--chapter:end:08-FLightR.Rmd-->

# Presentation of results {#presentation}

<!--chapter:end:09-presentation.Rmd-->

# Movemebank {#movebank}

<!--chapter:end:10-movebank.Rmd-->
